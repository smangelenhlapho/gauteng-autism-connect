  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Autism Connect Gauteng" },
      {
        ...
        content:
          "Connecting families with autism support across Gauteng — schools, therapists, emergency care and resources.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;700;800&family=Figtree:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
  }),
